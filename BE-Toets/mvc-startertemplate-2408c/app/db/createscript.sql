...
VALUES
 ('Nike', 'Air Jordan 1', 'Hardloop', 180, 1, NULL, SYSDATE(6), SYSDATE(6)),
 ('Adidas', 'Yeezy Boost 350', 'Basketbal', 390, 1, NULL, SYSDATE(6), SYSDATE(6)),
 ('New Balance', 'Pixel 9 Pro', 'Casual', 175, 1, NULL, SYSDATE(6), SYSDATE(6));
